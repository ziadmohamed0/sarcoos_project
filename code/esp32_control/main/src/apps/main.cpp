...
Button          *btn_gripper_open       = nullptr;
...
Button          *btn_gripper_close        = nullptr;
...
extern "C" void app_main(void) {
    ...
    while(true) {
        ...
        mqtt->publish(topic_gripper_open, std::to_string(btn_gripper_open->GET()));
        ...
        mqtt->publish(topic_gripper_close, std::to_string(btn_gripper_close->GET()));
...
void setup_HW() {
    ...
    btn_gripper_open     = new Button(GPIO_NUM_5);
    ...
    btn_gripper_close    = new Button(GPIO_NUM_18);
